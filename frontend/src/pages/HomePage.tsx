    ...
    <div className="flex gap-5 flex-wrap p-5">
      <div className="flex-1 min-w-[300px]">
        ...
        <div className="mt-5 p-4 bg-blue-50 text-blue-800 rounded-lg border border-blue-200">
          <p className="mb-2">
            <strong>Create Game:</strong> Enter your username and click "Create
            Game" to start a new game room.
          </p>
          <p className="mb-2">
            <strong>Join Game:</strong> Enter your username and a game ID to
            join an existing game.
          </p>
          <p>
            If no opponent joins within 10 seconds, a bot will automatically
            join your game.
          </p>
        </div>
      </div>
